...
public class SohuMailtask implements Runnable {
    String sender;
    String passwprd;
    String REC;
    String[] BasicMessage;

    public SohuMailtask(String[] BasicMessage,String sender,String REC,String passwprd){
...
//        ts.connect("smtp.qq.com",465, "879696519@qq.com", "txyahcbmmrzjbdhg");
            ...
            ts.connect("smtp.sohu.com", sender, passwprd);
