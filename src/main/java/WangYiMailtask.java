...
public class WangYiMailtask implements Runnable{
    String sender;
    String passwprd;
    String REC;
    String[] BasicMessage;

    public WangYiMailtask(String[] BasicMessage,String sender,String REC,String passwprd){
...
//        ts.connect("smtp.qq.com",465, "879696519@qq.com", "txyahcbmmrzjbdhg");
        ...
        ts.connect("smtp.163.com",465, sender, passwprd);
